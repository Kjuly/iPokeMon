...
- (id)initWithItemCount:(NSUInteger)itemCount
               ...
               delegate:(NSObject <PoketchTabBarDelegate> *)customTabBarDelegate
{
  if (self = [super init])
  {
    ...
    // Set the delegate
    delegate_ = customTabBarDelegate;
...
- (void)glowItemAtIndex:(NSInteger)index
{
  ...
  UIImage * glowImage = [delegate_ glowImage];
...
- (void)addTabBarArrowAtIndex:(NSUInteger)itemIndex
{
  UIImage * tabBarArrowImage = [delegate_ tabBarArrowImage];
...
- (UIButton *)buttonAtIndex:(NSUInteger)itemIndex width:(CGFloat)width
{
  ...
  UIImage * rawButtonImage = [delegate_ imageFor:self atIndex:itemIndex];
  ...
  UIImage * buttonPressedImage = [self tabBarImage:rawButtonImage size:button.frame.size backgroundImage:[delegate_ selectedItemBackgroundImage]];
