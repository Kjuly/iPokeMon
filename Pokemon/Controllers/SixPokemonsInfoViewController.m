...
- (void)loadView
{
  ...
  [speciesValue setText:[pokemonBaseInfo.species stringValue]];
  ...
  [typeValue setText:[pokemonBaseInfo.type1 stringValue]];
  ...
  [descriptionField setText:pokemonBaseInfo.info];
